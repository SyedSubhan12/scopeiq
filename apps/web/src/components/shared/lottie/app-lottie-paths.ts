/** Public URLs for Lottie JSON under `apps/web/public/lottie/`. */
export const APP_LOTTIE = {
  loading: "/lottie/sandy-loading-new.json",
  notFound: "/lottie/error-404.json",
} as const;

/** Marketing homepage hero decorations. */
